...
function bookingModalData_callback() {
    ...
    echo '<div class="wpbs-modal-box-content wpbs-calendar-'.$calendar['calendarID'].'">';
        echo wpbs_edit_dates( array( 'customRange' => true, 'startDate' => $_POST['startDate'], 'endDate' => $_POST['endDate'], 'calendarData' => $calendar['calendarData'], 'calendarLegend' => $calendar['calendarLegend'], 'currentTimestamp' => time(), 'calendarLanguage' => 'en', 'bookingID' => $_POST['bookingID'] ) ) ;    
