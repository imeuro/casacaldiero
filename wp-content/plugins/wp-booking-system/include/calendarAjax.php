...
function changeDay_callback() {
    ...
    if(in_array($_POST['calendarSelectionType'],array('single','multiple','fixed','week'))) $calendarSelectionType = $_POST['calendarSelectionType']; else $calendarSelectionType = 'multiple';
