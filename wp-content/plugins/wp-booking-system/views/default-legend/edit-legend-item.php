...
<div class="wrap wpbs-wrap">
    ...
    <?php $calendarLegend = json_decode(get_option('wpbs-default-legend'),true); $legendID = (!empty($_GET['legendID'])) ? $_GET['legendID'] : ''; 
     if(!empty($_GET['legendID'])) $legend = $calendarLegend[$legendID]; ?>    
        <div class="postbox-container meta-box-sortables">
            <form action="<?php echo admin_url( 'admin.php?page=wp-booking-system-default-legend&do=save-legend&noheader=true');?>" method="post">
            ...
            <div class="wpbs-buttons-wrapper">
                ...
                <a class="button secondary-button button-h2 button-h2-back-margin" href="<?php echo admin_url( 'admin.php?page=wp-booking-system-default-legend&do=edit-legend');?>"><?php echo __("Back",'wpbs') ;?></a>
            </div>
