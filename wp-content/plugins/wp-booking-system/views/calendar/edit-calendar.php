    ...
    <?php if(($wpdb->num_rows > 0 || $_GET['id'] == 'wpbs-new-calendar') && (@in_array( get_current_user_id(), json_decode($calendar['calendarUsers'])) || current_user_can( 'manage_options' )) ):?>
        ...
        <div class="postbox-container meta-box-sortables">
            ...
            <div class="wpbs-buttons-wrapper">
                ...
                <!-- <a class="button button-primary button-h2" href="<?php echo admin_url( 'admin.php?page=wp-booking-system&do=export-calendar&id=' . $_GET['id'] );?>"><?php echo __("Export",'wpbs') ;?></a> -->
            ...
            <br />
            <input type="submit" class="button button-primary saveCalendar" value="<?php echo __("Save Changes",'wpbs') ;?>" />
            </form>
        </div>
    <?php else:?>
