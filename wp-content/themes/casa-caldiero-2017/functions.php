...
function _tk_scripts() {
	...
	// G fonts
	wp_enqueue_style( 'Gfonts', 'https://fonts.googleapis.com/css?family=EB+Garamond|Pontano+Sans', false, '4.1.0' );

	// load Font Awesome css
	wp_enqueue_style( '_tk-font-awesome', 'https://use.fontawesome.com/4416d61fea.css', false, '4.1.0' );

	// load _tk styles
	wp_enqueue_style( '_tk-style', get_stylesheet_uri() );

	wp_enqueue_style( 'datepicker', THEME_DIR_URI . '/includes/css/datepicker.css', false, '1.0' );

	// has always the last word
	wp_enqueue_style( 'casacaldiero', THEME_DIR_URI . '/includes/css/casacaldiero.css', false, '1.0' );
	...
	wp_enqueue_script( 'datepicker', THEME_DIR_URI . '/includes/js/bootstrap-datepicker.js', array('_tk-bootstrapjs') );

	// has always the last word
	wp_enqueue_script( 'casacaldiero', THEME_DIR_URI . '/includes/js/casacaldiero.js', array('datepicker') );
